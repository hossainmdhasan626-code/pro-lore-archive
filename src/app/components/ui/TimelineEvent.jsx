  ...
  return (
    ...
    >
      ...
      >
        ...
        top-2 w-2.5 h-2.5 
        rounded-full 
        border border-gold-border-dim bg-main-app-bg 
        group-hover:border-gold-accent-primary group-hover:bg-gold-accent-primary/20 
      ...
      >
        <div
          ...
          border border-gold-border-dim hover:border-gold-accent-primary/40 
          transition-all duration-300
          cursor-pointer
          rounded-sm
        "
        >
          ...
          <h3
            className="pt-2 
          font-cinzel text-lg font-semibold text-text-heading-primary tracking-wide"
          >
            {title}
          </h3>
          ...
          <p
            className="pt-2 font-crimson text-[15px] italic text-text-body-secondary 
